...
- Usage: Reference from command with `@/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
