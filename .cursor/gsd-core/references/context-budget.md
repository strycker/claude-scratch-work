...
The keys live in `.claude/settings.json` (project) or `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/settings.json` (global) — **not** in `.planning/config.json`:
