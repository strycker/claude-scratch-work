...
```markdown
Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-ui-checker.md for instructions.
...
@/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
conversational prompting — **Specify** (→ `covered`, write a concrete truth) / **Dismiss (reason required)** /
