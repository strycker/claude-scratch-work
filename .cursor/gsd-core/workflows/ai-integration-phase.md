...
```markdown
Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-eval-planner.md for instructions.
