...
Key references:
- @/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/references/ui-brand.md (display patterns)
- @/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/USER-PROFILE.md" "/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/references/user-profiling.md`
...
Reference: @/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       <resolved claude_md_path, default ./.cursor/.cursor/rules/>
  ✓ Global .cursor/rules/        /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.cursor/rules/
```
