...
```
Agent(
  prompt="Read /Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/templates/SECURITY.md`
