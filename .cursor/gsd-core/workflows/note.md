...
- **Global scope**: `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/notes/`)
...
2. Glob `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/notes/` — works in any directory
