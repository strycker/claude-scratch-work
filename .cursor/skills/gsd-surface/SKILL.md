...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.gsd-surface.json`
(sibling to `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/skills/gsd-*/`.
...
(`/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor`), NOT the skills sub-directory (`/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor` as `configDir`. The skill dirs themselves live at
`/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor}"
SCOPE="global"
...
(i.e. `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.gsd-surface.json`
Install profile marker: `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/.gsd-profile`
Skill dirs: `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/skills/gsd-*/`
Engine module: `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/glestryc/personal/github_repos/claude-scratch-work/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
