...
def test_confusion_matrix_runs_without_error():
    ...
    from market_regime.plotting import plot_confusion_matrix
    ...
    with patch("market_regime.plotting._save_or_show") as mock_save:
...
def test_confusion_matrix_normalized_values():
    ...
    with patch("market_regime.plotting._save_or_show"):
        # Should not raise
