...
**Verification depth scales with `asvs_level`** (see @/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/references/security-asvs-levels.md for full definitions):
