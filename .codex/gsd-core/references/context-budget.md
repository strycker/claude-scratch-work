...
The keys live in `.codex/settings.json` (project) or `/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/settings.json` (global) — **not** in `.planning/config.json`:
