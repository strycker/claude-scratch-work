...
`@/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
