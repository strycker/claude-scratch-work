...
INSTALL_JS_GLOBAL="/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
