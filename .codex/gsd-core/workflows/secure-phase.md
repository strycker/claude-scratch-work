...
```
Agent(
  prompt="Read /Users/glestryc/personal/github_repos/claude-scratch-work/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/templates/SECURITY.md`
