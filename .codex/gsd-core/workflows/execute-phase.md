...
per-agent branch namespace `agent-*` / `worktree-agent-*`, NOT the `.codex/worktrees/` path: the
...
@/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/references/offer-next.md
</step>
