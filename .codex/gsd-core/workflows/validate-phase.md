...
```
Agent(
  prompt="Read /Users/glestryc/personal/github_repos/claude-scratch-work/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/glestryc/personal/github_repos/claude-scratch-work/.codex/gsd-core/templates/VALIDATION.md`
