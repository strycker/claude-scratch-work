...
```markdown
Read /home/user/claude-scratch-work/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/claude-scratch-work/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/claude-scratch-work/.claude/agents/gsd-ui-checker.md for instructions.
