...
```
Agent(
  prompt="Read /Users/glestryc/personal/github_repos/claude-scratch-work/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/gsd-core/templates/SECURITY.md`
