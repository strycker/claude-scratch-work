...
<reference>
@/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/gsd-core/references/user-profiling.md` to load:
