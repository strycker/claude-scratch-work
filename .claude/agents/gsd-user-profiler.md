...
<reference>
@/home/user/claude-scratch-work/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/claude-scratch-work/.claude/gsd-core/references/user-profiling.md` to load:
