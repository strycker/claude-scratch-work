...
Use template from `/home/user/claude-scratch-work/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/home/user/claude-scratch-work/.claude/gsd-core/templates/UI-SPEC.md`
