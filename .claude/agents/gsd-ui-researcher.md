...
Use template from `/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
