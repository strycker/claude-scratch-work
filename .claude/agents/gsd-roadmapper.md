...
Reference full template: `/home/user/claude-scratch-work/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/claude-scratch-work/.claude/gsd-core/templates/state.md`.
