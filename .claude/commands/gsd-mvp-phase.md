...
<execution_context>
@/home/user/claude-scratch-work/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/claude-scratch-work/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
