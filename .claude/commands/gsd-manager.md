...
<execution_context>
@/home/user/claude-scratch-work/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/claude-scratch-work/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
