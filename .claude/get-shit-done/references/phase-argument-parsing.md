...
```bash
PHASE_INFO=$(node "/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/Users/glestryc/personal/github_repos/claude-scratch-work/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
